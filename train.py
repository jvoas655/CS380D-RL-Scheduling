...
parser.add_argument('--entropy_coef', type=float, default=0.02, help='entropy loss weight')
...
# model settings
parser.add_argument('--input_dim', type=int, default=9, help='input dim')
...
model = ModelHeterogene(input_dim=args.input_dim,
                        ...
                        res=args.res,
                        withbn=args.withbn,
                        processor_nodes=args.processor_nodes)
